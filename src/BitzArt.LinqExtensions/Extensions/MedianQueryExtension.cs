...
public static class MedianQueryExtension
{
    ...
    /// Normally, when the number of elements is even, the median is calculated as the average of the two middle elements. <br />
    ...
    /// You should implement your own median calculation method if you need a more mathematically precise result.
    /// </summary>
